...
import com.company.springminiframework.annotations.ComponentScan;
import com.company.springminiframework.annotations.Configuration;
    ...
    private static class Spring {
        ...
        private static void initializeSpringContext(Class<?> clss) {
            ...
            if (!clss.isAnnotationPresent(Configuration.class)) {
                ...
                String packageStructure = "out/production/MiniSpringIOCFramework/" + value.replace(".", "/");
